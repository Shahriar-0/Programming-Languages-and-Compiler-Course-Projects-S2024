...
public class FunctionCraftParser extends Parser {
	...
	public static final int
		...
		RULE_pushStatement = 11, RULE_chopStatement = 12, RULE_chompStatement = 13, 
		RULE_loopDoStatement = 14, RULE_loopBody = 15, RULE_forStatement = 16, 
		RULE_range = 17, RULE_matchPatternStatement = 18, RULE_assignment = 19, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"putsStatement", "lenStatement", "pushStatement", "chopStatement", "chompStatement", 
			"loopDoStatement", "loopBody", "forStatement", "range", "matchPatternStatement", 
			"assignment", "accessList", "statement", "body", "expression", "eqaulityExpression", 
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			((FunctionDeclarationContext)_localctx).id = match(IDENTIFIER);
					...
					_localctx.functionDeclarationRet.setLine((((FunctionDeclarationContext)_localctx).id!=null?((FunctionDeclarationContext)_localctx).id.getLine():0));
	...
	public final ChopStatementContext chopStatement() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_chopStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(277);
	...
	public final ChompStatementContext chompStatement() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_chompStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(283);
		...
		try {
			...
			if (_la==RETURN) {
				...
				((LoopBodyContext)_localctx).r = returnStatement();
							...
							_localctx.loopRetStmt.setLine(((LoopBodyContext)_localctx).r.returnStmtRet.getLine());
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			((ForStatementContext)_localctx).l = loopBody();
					...
					_localctx.forStRet.setLine((((ForStatementContext)_localctx).id!=null?((ForStatementContext)_localctx).id.getLine():0));
	...
	public final MatchPatternStatementContext matchPatternStatement() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_matchPatternStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(360);
		...
		try {
			...
			case ASSIGN:
				...
				((AssignmentContext)_localctx).as = match(ASSIGN);
							...
							line = (((AssignmentContext)_localctx).as!=null?((AssignmentContext)_localctx).as.getLine():0);
			...
			case PLUS_ASSIGN:
				...
				((AssignmentContext)_localctx).pl = match(PLUS_ASSIGN);
								...
								line = (((AssignmentContext)_localctx).pl!=null?((AssignmentContext)_localctx).pl.getLine():0);
			...
			case MINUS_ASSIGN:
				...
				((AssignmentContext)_localctx).mi = match(MINUS_ASSIGN);
								...
								line = (((AssignmentContext)_localctx).mi!=null?((AssignmentContext)_localctx).mi.getLine():0);
			...
			case DIVIDE_ASSIGN:
				...
				((AssignmentContext)_localctx).di = match(DIVIDE_ASSIGN);
								...
								line = (((AssignmentContext)_localctx).di!=null?((AssignmentContext)_localctx).di.getLine():0);
			...
			case MULT_ASSIGN:
				...
				((AssignmentContext)_localctx).mu = match(MULT_ASSIGN);
								...
								line = (((AssignmentContext)_localctx).mu!=null?((AssignmentContext)_localctx).mu.getLine():0);
			...
			case MOD_ASSIGN:
				...
				((AssignmentContext)_localctx).mo = match(MOD_ASSIGN);
								...
								line = (((AssignmentContext)_localctx).mo!=null?((AssignmentContext)_localctx).mo.getLine():0);
			...
			case 1:
				...
				case EQUAL:
					...
					((EqaulityExpressionContext)_localctx).op1 = match(EQUAL);
								...
								line = (((EqaulityExpressionContext)_localctx).op1!=null?((EqaulityExpressionContext)_localctx).op1.getLine():0);
				...
				case NOT_EQUAL:
					...
					((EqaulityExpressionContext)_localctx).op2 = match(NOT_EQUAL);
									...
									line = (((EqaulityExpressionContext)_localctx).op2!=null?((EqaulityExpressionContext)_localctx).op2.getLine():0);
				...
				if ( _alt==1 ) {
					...
					case GREATER_THAN:
						...
						((RelationalExpressionContext)_localctx).gt = match(GREATER_THAN);
						          			...
						          			line = (((RelationalExpressionContext)_localctx).gt!=null?((RelationalExpressionContext)_localctx).gt.getLine():0);
					...
					case LESS_THAN:
						...
						((RelationalExpressionContext)_localctx).lt = match(LESS_THAN);
						          				...
						          				line = (((RelationalExpressionContext)_localctx).lt!=null?((RelationalExpressionContext)_localctx).lt.getLine():0);
					...
					case LESS_EQUAL_THAN:
						...
						((RelationalExpressionContext)_localctx).let = match(LESS_EQUAL_THAN);
						          				...
						          				line = (((RelationalExpressionContext)_localctx).let!=null?((RelationalExpressionContext)_localctx).let.getLine():0);
					...
					case GREATER_EQUAL_THAN:
						...
						((RelationalExpressionContext)_localctx).get = match(GREATER_EQUAL_THAN);
						          				...
						          				line = (((RelationalExpressionContext)_localctx).get!=null?((RelationalExpressionContext)_localctx).get.getLine():0);
				...
				if ( _alt==1 ) {
					...
					case PLUS:
						...
						((AdditiveExpressionContext)_localctx).p = match(PLUS);
						          			...
						          			line = (((AdditiveExpressionContext)_localctx).p!=null?((AdditiveExpressionContext)_localctx).p.getLine():0);
					...
					case MINUS:
						...
						((AdditiveExpressionContext)_localctx).m = match(MINUS);
						          			...
						          			line = (((AdditiveExpressionContext)_localctx).m!=null?((AdditiveExpressionContext)_localctx).m.getLine():0);
				...
				if ( _alt==1 ) {
					...
					case MULT:
						...
						((MultiplicativeExpressionContext)_localctx).m = match(MULT);
						          			...
						          			line = (((MultiplicativeExpressionContext)_localctx).m!=null?((MultiplicativeExpressionContext)_localctx).m.getLine():0);
					...
					case DIVIDE:
						...
						((MultiplicativeExpressionContext)_localctx).d = match(DIVIDE);
						          				...
						          				line = (((MultiplicativeExpressionContext)_localctx).d!=null?((MultiplicativeExpressionContext)_localctx).d.getLine():0);
			...
			case DECREMENT:
				...
				case NOT:
					...
					((PreUnaryExpressionContext)_localctx).n = match(NOT);
								...
								line = (((PreUnaryExpressionContext)_localctx).n!=null?((PreUnaryExpressionContext)_localctx).n.getLine():0);
				...
				case MINUS:
					...
					((PreUnaryExpressionContext)_localctx).m = match(MINUS);
									...
									line = (((PreUnaryExpressionContext)_localctx).m!=null?((PreUnaryExpressionContext)_localctx).m.getLine():0);
				...
				case INCREMENT:
					...
					((PreUnaryExpressionContext)_localctx).i = match(INCREMENT);
									...
									line = (((PreUnaryExpressionContext)_localctx).i!=null?((PreUnaryExpressionContext)_localctx).i.getLine():0);
				...
				case DECREMENT:
					...
					((PreUnaryExpressionContext)_localctx).d = match(DECREMENT);
									...
									line = (((PreUnaryExpressionContext)_localctx).d!=null?((PreUnaryExpressionContext)_localctx).d.getLine():0);
	...
	public final LambdaFunctionContext lambdaFunction() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1150101502091851712L) != 0)) {
					{
					{
					...
					setState(610);
					((LambdaFunctionContext)_localctx).e = expression(0);

									args.add(((LambdaFunctionContext)_localctx).e.expRet);
					...
					while (_la==COMMA) {
						...
						match(COMMA);
						setState(613);
						((LambdaFunctionContext)_localctx).e2 = expression(0);

											args.add(((LambdaFunctionContext)_localctx).e2.expRet);
						...
						_la = _input.LA(1);
									...
									((LambdaFunctionContext)_localctx).lambdaRet =  new LambdaExpression(((LambdaFunctionContext)_localctx).fd.argRet, ((LambdaFunctionContext)_localctx).b.bodyRet, args);
									_localctx.lambdaRet.setLine((((LambdaFunctionContext)_localctx).a!=null?((LambdaFunctionContext)_localctx).a.getLine():0));
		...
		try {
			...
			case STRING_VALUE:
				...
				((ValuesContext)_localctx).s = match(STRING_VALUE);
							...
							((ValuesContext)_localctx).valRet =  new StringValue((((ValuesContext)_localctx).s!=null?((ValuesContext)_localctx).s.getText():null));
							_localctx.valRet.setLine((((ValuesContext)_localctx).s!=null?((ValuesContext)_localctx).s.getLine():0));
			...
			case INT_VALUE:
				...
				((ValuesContext)_localctx).i = match(INT_VALUE);
							...
							((ValuesContext)_localctx).valRet =  new IntValue((((ValuesContext)_localctx).i!=null?Integer.valueOf(((ValuesContext)_localctx).i.getText()):0));
							_localctx.valRet.setLine((((ValuesContext)_localctx).i!=null?((ValuesContext)_localctx).i.getLine():0));
			...
			case FLOAT_VALUE:
				...
				((ValuesContext)_localctx).float_ = match(FLOAT_VALUE);
							...
							((ValuesContext)_localctx).valRet =  new FloatValue(Float.parseFloat((((ValuesContext)_localctx).float_!=null?((ValuesContext)_localctx).float_.getText():null)));
							_localctx.valRet.setLine((((ValuesContext)_localctx).float_!=null?((ValuesContext)_localctx).float_.getLine():0));
		...
		try {
			...
			case TRUE:
				...
				((BoolValueContext)_localctx).t = match(TRUE);
						...
						_localctx.boolValRet.setLine((((BoolValueContext)_localctx).t!=null?((BoolValueContext)_localctx).t.getLine():0));
			...
			case FALSE:
				...
				((BoolValueContext)_localctx).f = match(FALSE);
							...
							_localctx.boolValRet.setLine((((BoolValueContext)_localctx).f!=null?((BoolValueContext)_localctx).f.getLine():0));
