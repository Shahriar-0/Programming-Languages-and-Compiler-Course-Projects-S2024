...
public class Visitor<T> implements IVisitor<T> {
	...
	@Override
	public T visit(PatternDeclaration patternDeclaration) {
		return null;
	}
	...
	@Override
	public T visit(PutStatement putStatement) {
		return null;
	}

	@Override
	public T visit(LenStatement lenStatement) {
		return null;
	}

	@Override
	public T visit(PushStatement pushStatement) {
		return null;
	}

	@Override
	public T visit(LoopDoStatement loopDoStatement) {
		return null;
	}
	...
	@Override
	public T visit(MatchPatternStatement matchPatternStatement) {
		return null;
	}

	@Override
	public T visit(ChopStatement chopStatement) {
		return null;
	}

	@Override
	public T visit(ChompStatement chompStatement) {
		return null;
	}

	@Override
	public T visit(AssignStatement assignStatement) {
		return null;
	}
	...
	@Override
	public T visit(AppendExpression appendExpression) {
		return null;
	}
	...
	@Override
	public T visit(FunctionPointer functionPointer) {
		return null;
	}
	...
	@Override
	public T visit(NextStatement nextStatement) {
		return null;
	}
